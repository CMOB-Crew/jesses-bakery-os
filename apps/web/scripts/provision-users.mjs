...
// ---------------------------------------------------------------------------
// The word list lives in lib/password-words.json so that this script and
// apps/web/lib/passwords.ts cannot drift. Two copies of 512 words drift and
// nobody notices until somebody asks why two passwords from the same system
// look different. Moved there 15 September 2026.
const WORDS = JSON.parse(
  readFileSync(new URL("../lib/password-words.json", import.meta.url), "utf8"),
);
