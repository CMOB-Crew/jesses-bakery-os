...
// Suggestion cards — same questions the answer engine already handles.
const QCARDS: { key: string; q: string; label: string; tag: string; bg: string; stroke: string; icon: React.ReactNode }[] = [
  ...
  { key: "stockouts", q: "Any Sunday stockout risk?", label: "Any Sunday stockout risk?", tag: "Stockouts", bg: "var(--amber-b)", stroke: "#7c5308", icon: <><circle cx="12" cy="12" r="9" /><path d="M12 7v5l3 2" /></> },
      ...
      <div className="grid2">
        <div className="thread">
          {!hasThread && (
            <div className="welcome">
              ...
              <p>I can see this week&apos;s live data across all your stores — waste, savings, what to cut, which stores need attention, Sunday stockouts. Ask away, or tap a suggestion on the right.</p>
        ...
        <aside className="rail">
          ...
          <div className="factcard">
            ...
            <div className="factrow"><span className="fk">Loaves the engine saves / wk</span><span className="fv g">{facts?.savedWk != null ? nf(facts.savedWk) : "—"}</span></div>
          </div>
        </aside>
      </div>
