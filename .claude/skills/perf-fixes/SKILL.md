...
5. Auth is off locally. Anything a card says about being signed in, roles, or row-level security can only be checked on the preview site with `AUTH_ENFORCED=1`. Do the local part and say plainly which part still needs the preview site.
